...
<?php if(is_array($detail)): foreach($detail as $key=>$vo): ?><div class="weui-cell weui-cell_access">
                <div class="weui-cell__bd">
                    <span style="vertical-align: middle"><?php echo ($vo['stu_info']['realname']); ?>&emsp;&emsp;<?php echo ($vo['stu_info']['schoolnum']); ?>&emsp;&emsp;<?php echo ($vo['sign_status']); ?></span>
                    
                </div>
                <a href="<?php echo U('Teacher/stuInfo',array('id'=>$vo['stu_info']['id']));?>"><div class="weui-cell__ft">学生详细信息</div></a>
